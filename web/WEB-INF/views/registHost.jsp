            ...
            <form class="form" method="post" action="/registhost">
                ...
                <div class="company_info">
                    <table>
                        <tr>
                            <td><h4>상호명</h4></td>
                            <td><input type="text" id="company_name" name="company_name" placeholder=" 상호명를 입력하세요.">
                            </td>
                        </tr>
                        <tr>
                            <td><h4>사업자등록번호</h4></td>
                            <td><input type="text" id="company_registration_name" name="company_registration_name"
                                       placeholder=" 사업자등록번호를 입력하세요."></td>
                        </tr>
                        <tr>
                            <td><h4>대표자명</h4></td>
                            <td><input type="text" id="company_representative_name" name="company_representative_name"

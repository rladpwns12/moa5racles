              ...
              <div class="content1" id="content1">
				...
				<div class="content2" id="content2" style="display: none;">
					...
					<div class="product_size_1">
						5호 박스 개수 <input type="number" id="box" class="sizeCnt" name="productSize[0]" min=0 max=100 value=0>개
					</div>
					...
					<div class="product_size_2">
						자전거 이상 크기 <input type="number" id="bicycle" class="sizeCnt" name="productSize[1]" min=0 max=100 value=0>개
						<input type="hidden" id="secondMultiple" value="${multiplePriceList[1]}">
					</div>
					<div class="product_size_3">
						싱글 침대 이상 크기 <input type="number" id="bed" class="sizeCnt" name="productSize[2]" min=0 max=100 value=0>개

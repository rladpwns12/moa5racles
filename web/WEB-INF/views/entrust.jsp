...
<head>
    ...
    <script type="text/javascript">
        $(document).on("click", "i[name=add_row_btn]", function () {
            ...
            addStaffText += '<td class="table_data"><input type="number" class="product_cnt" name="productCnt" min=0 max=100 value=0></td>';
            addStaffText += '<td><i class="fas fa-minus-circle" style="font-size: 30px" onclick="deleteRow(this)"/></td> + </tr>';
                var trHtml = $("tr[name=stuff]:last"); //last를 사용하여 trStaff라는 명을 가진 마지막 태그 호출
            trHtml.before(addStaffText); //마지막 trStaff명 뒤에 붙인다
        });
    </script>
                ...
                <div class="content1" id="content1">
                    ...
                    <table class='entrust_product_tb'>
                        ...
                        <tr name='stuff'>
                            ...
                            <%--<td>
                                <i class="fas fa-minus-circle" style="font-size: 30px" onclick="deleteRow(this)"/>
                            </td>--%>
                        </tr>
                        <tr name='stuff'>
                ...
                <div class="content3" id="content3" style="display: none;">
                    ...
                    <div class="price_class">
                        ...
                        <div class="price_e2">
                            ...
                            <input type="text" id="bargain" class="i_price" name="price.bargainPrice" value="0" disabled
                                   numberOnly="true">
                        </div>
                    </div>
                </div>
